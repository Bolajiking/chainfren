...
export const PUBLIC_PRODUCT_MATURITY = [
  { id: 'media-launchpad', label: 'Media Launchpad', maturity: 'early-access', href: '/products/media-launchpad' },
  { id: 'creator-growth-os', label: 'Creator Growth OS', maturity: 'live-core', href: '/products/creator-growth-os' },
  { id: 'community-engine', label: 'Community Engine', maturity: 'live-core', href: '/products/community-engine' },
