...
export const PUBLIC_DESTINATIONS = {
  distribution: { sabi: '/sabi', 'creator-network': '/creator-network', 'star-factor': '/thesis/read/the-road-ahead', 'products-and-solutions': '/products' },
...
export function validatePublicSystem(system, chapterSlugs = new Set()) {
  ...
  requireSequence(system.DISTRIBUTION_LOOP, ['sabi', 'creator-network', 'star-factor', 'products-and-solutions'], 'Distribution loop', PUBLIC_DESTINATIONS.distribution)
