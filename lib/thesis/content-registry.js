...
import { createChapterRegistry } from './chapter-registry.mjs'

export const CHAPTER_COMPONENTS = {
  'the-gap': TheGap,
  'the-trap': TheTrap,
  'the-unlock': TheUnlock,
  'the-thesis': TheThesis,
...
export const CHAPTER_REGISTRY = createChapterRegistry(CHAPTER_COMPONENTS)
