...
import { CHAPTER_REGISTRY } from './content-registry'
...
export const getPublishedChapters = () => CHAPTER_REGISTRY.getPublished(THESIS_MANIFEST)
export const getChapterBySlug = (slug) => chaptersBySlug.get(slug) ?? null
export const getChapterComponent = (slug) => CHAPTER_REGISTRY.get(slug)
...
export const getPublishedChapterNavigation = (slug) => {
