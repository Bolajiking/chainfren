...
const About = () => {
  ...
  return (
    <div id='about' className=' py-4  relative flex flex-col text-white justify-center items-center test bg-primary w-full 2xl:max-w-[1170px] mx-auto'>
        <div className="flex py-8 pb-48   lg:pb-96 flex-col items-center justify-center md:w-[700px]  lg:w-[1100px] px-5 md:px-0 text-center gap-8 lg:gap-0 z-[1]">
        ...
        <Image src={pic1} className='z-[1] absolute bottom-[40px] px-4 md2:px-0' width={700} height={600} />
        </div>
