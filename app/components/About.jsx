...
const About = () => {
  ...
  return (
    <div className=' py-4  relative flex flex-col text-white justify-center items-center test bg-primary '>
        <div className="flex py-16 flex-col items-center justify-center w-[550px] text-center gap-12 z-[1]">
...
Our team of experts is passionate about helping brands and businesses navigate the rapidly evolving world of crypto and blockchain technologies</div>
        ...
        <div className="absolute right-0 bottom-0 z-[1]"><Image src={pic1} width={300} height={300} /></div>
        <div className="absolute left-0 bottom-0 z-[1]"><Image src={pic2} width={350} height={350} /></div>
    </div>
  )
}
