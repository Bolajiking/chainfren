...
const Services = () => {
  return (
    <div className='bg-primary flex justify-center items-center text-white h-[150vh]'>
        <div className="xl:w-[1050px] flex justify-center items-center flex-col gap-16">
        ...
        <div className="flex flex-wrap w-full justify-between gap-10">
            <div className=" w-[48%] z-[1] h-[16rem] border-[1px] p-8 flex flex-col gap-4 border-[#0E1435CC] bg-[url('/card-bg.png')] card relative overflow-hidden rounded-md onex bg-[length:300px_300px] bg-no-repeat bg-right-top "> 
            ...
            <div className=" w-[48%] z-[1] h-[16rem] border-[1px] p-8 flex flex-col gap-4 border-[#0E1435CC] bg-[url('/card-bg.png')] card relative overflow-hidden rounded-md twox bg-[length:300px_300px] bg-no-repeat bg-right-top"> 
            ...
            <div className=" w-[48%] z-[1] h-[16rem] border-[1px] p-8 flex flex-col gap-4 border-[#0E1435CC] bg-[url('/card-bg.png')] card relative overflow-hidden rounded-md threex bg-[length:300px_300px] bg-no-repeat bg-right-top"> 
            ...
            <div className=" w-[48%] z-[1] h-[16rem] border-[1px] p-8 flex flex-col gap-4 border-[#0E1435CC] bg-[url('/card-bg.png')] card relative overflow-hidden rounded-md fourx bg-[length:300px_300px] bg-no-repeat bg-right-top"> 
