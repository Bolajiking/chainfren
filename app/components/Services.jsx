  ...
  return (
    <div id='services' className='bg-primary flex justify-center items-center text-white '>
        ...
        <div className="flex flex-wrap  flex-col md:flex-row w-full justify-between gap-y-6 px-4 md:px-8">
            <div className="w-full mx-auto group/card sm:w-[90%] md:w-[48%] bg-primary z-[1] h-[16rem] border-[1px] p-4 lg:p-8 flex flex-col gap-4 border-[#0E1435CC] bg-[url('/card-bg.png')] relative overflow-hidden rounded-md  bg-[length:200px_200px] md:bg-[length:300px_300px] bg-no-repeat bg-right-top "> 
