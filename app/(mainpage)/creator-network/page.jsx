...
const FAQ_JSONLD = [
  { q: 'What is the Chainfren Creator Network?', a: 'The Chainfren Creator Network is a curated network of African creators, international crypto KOLs, and partner marketing agencies, built exclusively for onchain brands. It is Chainfren’s creator-sourcing division.' },
  ...
  { q: 'How do brands work with the network?', a: 'Brands send a brief; Chainfren returns a matched, vetted roster, supports activation, and handles creator payment in stablecoins.' },
  ...
  { q: 'What makes Chainfren different?', a: 'Chainfren works exclusively with onchain brands and specialises in bridging mainstream creators into crypto credibly — curated, vetted, campaigns built for onchain acquisition, and instant stablecoin settlement.' },
...
function JsonLd() {
  const faqSchema = { '@context': 'https://schema.org', '@type': 'FAQPage', mainEntity: FAQ_JSONLD.map(({ q, a }) => ({ '@type': 'Question', name: q, acceptedAnswer: { '@type': 'Answer', text: a } })) }
  const serviceSchema = {
    '@context': 'https://schema.org', '@type': 'Service', serviceType: 'Creator marketing / influencer network',
    provider: { '@type': 'Organization', name: 'Chainfren' }, areaServed: ['Africa', 'Global'],
    audience: [{ '@type': 'Audience', audienceType: 'Onchain brands' }, { '@type': 'Audience', audienceType: 'Creators' }],
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: 'Solutions', item: 'https://chainfren.com/solutions' },
      { '@type': 'ListItem', position: 2, name: 'Creator Network', item: 'https://chainfren.com/creator-network' },
    ],
  }
  return (
    <>
