        ...
        <div className="flex flex-col flex-wrap w-full  gap-4 mx-auto px-8 font-serif">
            {
                blogEntries.items.map((post,index)=>{
                    ...
                    return(
                        ...
                        <Link href={`./blog/${slug}`}>
                        <div key={index} className=" overflow-hidden h-[15rem] items-center  flex flex-col  rounded-[10px] border-[1px] hover:border-[2px] hover:border-[#000] bg-[#F0F0F0] dark:bg-[#0A0623] z-[1] border:text-[#606060] dark:border-[#40CBFF]">
