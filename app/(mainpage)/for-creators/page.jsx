...
export const metadata = {
  ...
  description: 'Tools, deals, and infrastructure for African creators to own their audience and monetize directly. Join the Chainfren Creator Network and get paid in stablecoins.',
}
...
const OFFERINGS = [
  {
    label: 'Own your audience', tag: 'Agency', bg: CF.cyan, href: '/agency',
    body: 'Done-with-you growth: owned audience, direct payments, onchain identity.',
    cta: 'See agency programs',
  },
  {
    label: 'Creator tools', tag: 'Product', bg: CF.periwinkle, href: '/products',
    body: 'The products that let you monetize and own your work directly.',
    cta: 'See products',
  },
  {
    label: 'Sabi', tag: 'Media', bg: '#F1F3F8', href: '/media',
    body: "Get your work onto Africa's onchain broadcasting network.",
    cta: 'Visit Sabi',
  },
]
...
export default function ForCreatorsPage() {
  return (
    <div style={{ background: CF.white, fontFamily: 'var(--font-inter), "Inter Display", "Inter", sans-serif' }}>
      <SiteHeader links={DEFAULT_LINKS} accent={CF.mint} cta={DEFAULT_CTA} />
      ...
      <section style={{ maxWidth: 1180, margin: '0 auto', padding: 'clamp(48px,8vw,80px) 16px 0' }}>
        ...
        <h2 style={{ fontSize: 'clamp(1.75rem, 3.5vw, 2.5rem)', fontWeight: 450, letterSpacing: '-0.02em', color: CF.dark, margin: '10px 0 32px' }}>
          Everything Chainfren offers creators.
        </h2>
        ...
        {/* ★ Surfaced Creator Network subsection */}
        <Link href="/agency/creator-network" style={{ textDecoration: 'none', display: 'block', marginTop: 8 }}>
          <div style={{
            ...CARD_BASE, background: CF.white, padding: 'clamp(24px, 4vw, 40px)',
            display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24, flexWrap: 'wrap',
          }}>
            <div style={{ flex: '1 1 320px', minWidth: 0 }}>
              <Eyebrow color={CF.accent}>Creator Network</Eyebrow>
              ...
              <p style={{ fontSize: 14.5, color: CF.muted, lineHeight: 1.6, maxWidth: 480 }}>
                Join Chainfren&apos;s curated network and get real campaigns with real budgets from leading onchain brands — vetted deals, no scams, and payment in stablecoins the moment you deliver.
              </p>
            </div>
            <span style={{
              display: 'inline-flex', alignItems: 'center', gap: 8, flexShrink: 0,
              padding: '13px 26px', borderRadius: 9999, border: `2px solid ${CF.dark}`, color: CF.dark,
              fontSize: 13, fontWeight: 500, letterSpacing: '0.04em', textTransform: 'uppercase',
            }}>Apply to join <Arrow /></span>
          </div>
        </Link>
      </section>
